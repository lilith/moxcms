//! Reproduction for moxcms#162: fixed-point trilinear vs tetrahedral divergence.
//!
...
//! — no matrix-shaper fallback. An exhaustive 256³ RGB input is transformed
//! via both interpolation methods and the results compared.
//!
